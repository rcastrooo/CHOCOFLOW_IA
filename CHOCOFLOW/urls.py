...
urlpatterns = [
    ...
    path('admin/supervisores/',views.gestionar_supervisores, name='gestionar_supervisores'),
    path('supervisor/empleados/',views.empleados_supervisor,name='empleados_supervisor'),

    #API DASHBOARD SUPERVISOR
    path('api/stats-supervisor/', views.api_stats_supervisor, name='api_stats_supervisor'),
